...
return [
    ...
    'mail' => [
        ...
        'refund' => [
            'heading' => 'Yêu cầu hoàn tiền #:refund_id cho đơn hàng #:order_id',
            'subject' => 'Hoàn tiền cho đơn hàng #:order_id của bạn',
            'summary' => 'Tóm tắt yêu cầu hoàn tiền',
            'adjustment-refund' => 'Adjustment Refund',
            'adjustment-fee' => 'Adjustment Fee'
        ],
        ...
        'forget-password' => [
            ...
            'final-summary' => 'Nếu bạn không gửi yêu cầu này thì hay bỏ qua email này và không thực hiện gì thêm',
            'thanks' => 'Thanks!'
        ],
        ...
        'update-password' => [
            ...
            'dear' => 'Xin chào :name',
            'info' => 'Bạn nhận được email này vì bạn vừa thực hiện thay đổi mật khẩu thành công.',
            'thanks' => 'Thanks!'
        ],

        'customer' => [
            'new' => [
                'dear' => 'Xin chào :customer_name',
                'username-email' => 'UserName/Email',
                'subject' => 'Tài khoản khách hàng mới',
                'password' => 'Password',
                'summary' => 'Tài khoản của bạn đã được tạo.
                Thông tin về tài khoản của bạn dưới đây: ',
                'thanks' => 'Thanks!',
            ],

            'registration' => [
                'subject' => 'Tạo tài khoản khách hàng mới',
                'customer-registration' => 'Đăng ký tài khoản khách hàng thành công',
                'dear' => 'Xin chào :customer_name',
                'greeting' => 'Chào mừng và cám ơn bạn đã trở thành khách hàng của chúng tôi!',
                'summary' => 'Tài khoản của bạn đã được tạo thành công và bạn có thể đăng nhập sử dụng email và mật khẩu của mình. Sau khi đăng nhập bạn sẽ có thể sử dụng các chức năng khác như Đánh giá sản phẩm đã mua, danh sách mong muốn và sửa thông tin cá nhân.',
                'thanks' => 'Thanks!',
            ],

            'verification' => [
                'heading' => config('app.name') . ' - Xác nhận email',
                'subject' => 'Xác nhận email',
                'verify' => 'Xác nhận tài khoản',
                'summary' => 'Email này nhằm xác nhận rằng địa chỉ email vừa đã nhập vào '. config('app.name').' là sở hữu bởi chính bạn.
                Hãy click vào nút Xác nhận tài khoản dưới đây để xác thực tài khoản của bạn.'
            ], 

            'subscription' => [
                'subject' => 'Subscription Email',
                'greeting' => ' Chào mừng tới ' . config('app.name') . ' - Email Subscription',
                'unsubscribe' => 'Hủy đăng ký',
                'summary' => 'Cám ơn bạn đã cho phép chúng tôi gửi email đến cho bạn. Đã được một lúc khi bạn đọc email từ ' . config('app.name') . ', chúng tôi không muốn làm loãng hòm thư của bạn. Nếu bạn không muốn nhận các email quảng cáo và tin tức từ chúng tôi nữa, bạn có thể click vào link bên dưới.'
            ]
        ]
    ],
    ...
    'response' => [
        'create-success' => ':name đã được tạo.',
        'update-success' => ':name đã được cập nhật.',
        'delete-success' => ':name đã được xóa.',
        'submit-success' => ':name đã được gửi.'
    ],
];
